...
**Type:** Chroma Technical Report (not peer-reviewed)  
**Source:** <https://research.trychroma.com/context-rot>  
**Code:** <https://github.com/chroma-core/context-rot>  
**Video walkthrough:** <https://www.youtube.com/watch?v=TUjQuC4ugak>

> Captured from the rendered web page on 2026-05-18 because the publisher does not provide a PDF version. Inline images reference the original URLs on research.trychroma.com — open this file in a markdown viewer with internet to see the figures.
...
![Context Rot: How Increasing Input Tokens Impacts LLM Performance](https://research.trychroma.com/img/context_rot/header_plot.png)
...
![](https://research.trychroma.com/img/context_rot/appendix/gemini_position_accuracy.png)
